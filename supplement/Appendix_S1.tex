...
\renewcommand\thesubsection{Section S\arabic{section}.\arabic{subsection}:}

\title{Appendix S1:

Diversity-stability relationships across organism groups and ecosystem types become decoupled across spatial scales \\ {\large \em{Ecology}}}
...
\doublespacing
\newpage
\section{Data sets used in this research}
Below, we list all the data sets used to perform the analysis. 
We include the name of the dataset (matching Table 1 in the main text), the location of the publicly available data on Environmental Data Initiative (EDI) or Ecological Archives and its package ID or accession number, and the citations to the data, which include the DOI of the data package. 

\begin{enumerate}
\item and-birds, EDI knb-lter-and.4781.2, \cite{and-birds} 
\item and-plants-mtStHelens, Ecological Archives E091-152, \cite{del_moral_thirty_2010} 
\item bes-birds, EDI knb-lter-bes.543.170, \cite{bes-birds} 
\item cap-birds, EDI knb-lter-cap.46.15, \cite{cap-birds} 
\item cap-herps, EDI knb-lter-cap.627.3, \cite{cap-herps} 
\item cdr-grasshopper, EDI knb-lter-cdr.106.8, \cite{cdr-grasshoppers}
\item cdr-plantsABC, EDI knb-lter-cdr.14.8, \cite{cdr-plants}
\item cdr-plantsD, EDI knb-lter-cdr.14.8,  \cite{cdr-plants}
\item fce-diatoms, EDI knb-lter-fce.1211.3,  \cite{fce-diatoms}
\item fce-fishDry, EDI knb-lter-fce.1164.7,  \cite{fce-fish}
\item fce-fishWet, EDI knb-lter-fce.1164.7,  \cite{fce-fish}
\item gce-mollusc, EDI, \cite{project_mollusc_2014,project_mollusc_2014-1,project_mollusc_2014-2,project_mollusc_2014-3,project_mollusc_2014-4,project_mollusc_2014-5,project_mollusc_2014-6,project_mollusc_2014-7,project_mollusc_2014-8,project_mollusc_2014-9,project_mollusc_2014-10,project_mollusc_2014-11,project_mollusc_2014-12,project_mollusc_2014-13} 
\item hays-plants, Ecological Archives E088-161, \cite{hay_data}
\item jrn-lizards, EDI knb-lter-jrn.2100007001.13, \cite{jrn-lizard}
...
%\includegraphics[scale = 0.4]{mcr-inverts-castorani_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{mcr-coral-castorani_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{mcr-algae-castorani_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{gce-mollusc-compagnoni_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{fce-fish-RehageDry_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{fce-fish-RehageWet_species_accumulation_space.pdf}
...
\includegraphics[scale = 0.4]{and-plants-mtStHelens_num_taxa_over_time.pdf}
\includegraphics[scale = 0.4]{and-plants-mtStHelens_spatiotemporal_sampling_effort.pdf}
%\includegraphics[scale = 0.4]{and-plants-mtStHelens_species_accumulation_space.pdf}
\includegraphics[scale = 0.4]{and-plants-mtStHelens_spp_shared.pdf}
...
%\includegraphics[scale = 0.4]{sev-arthropods-compagnoni_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{sev-grasshopper-compagnoni_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{cap-herps-banville_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{and-birds-wisnoski_species_accumulation_space.pdf}
...
%\includegraphics[scale = 0.4]{cap-birds-banville_species_accumulation_space.pdf}
