...
data.set <- "sev-plants-compagnoni"
data.set <- "sgs-plants-catano"
data.set <- "sgs-plants-compagnoni"
data.set <- "sev-arthropods-compagnoni"
...
pdf(file=here(paste("supplement/",data.set, '_spatiotemporal_sampling_effort.pdf',sep='')))
...
#write to file:
pdf(file=here(paste("supplement/",data.set, '_num_taxa_over_time.pdf',sep='')))
...
pdf(file=here(paste("supplement/",data.set,'_species_accumulation_curve.pdf', sep='')))
...
pdf(file=here(paste("supplement/",data.set,'_species_accumulation_space.pdf', sep='')))
...
pdf(file=here(paste("supplement/", data.set,'_spp_shared.pdf', sep='')))
...
write.csv(mtdt, file = here(paste("supplement/metadata_tables/",data.set,"_metadata.csv", sep="")), row.names=F)
